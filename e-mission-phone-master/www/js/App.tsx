...
const URL_SCHEME =
  packageJson.cordova?.plugins?.['cordova-plugin-customurlscheme']?.URL_SCHEME ||
  packageJson['cordova-cordovabuild']?.plugins?.['cordova-plugin-customurlscheme']?.URL_SCHEME ||
  'emission';
